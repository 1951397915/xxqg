"ui";
var 获取内容 = http.get("https://1951397915.github.io/qiangguoyanzheng/qgxx/公告");
            ...
            <ScrollView>
                 <horizontal padding="8 8" h="auto">
                     ...
                     <text id="jqm" textSize="16sp" textColor={主题颜色} text={jqm} />
                            ...
                            <card w="*" h="50" cardCornerRadius="10dp" cardElevation="0dp" margin="20 15" >
                                 <View w="*" h="*" bg="#99CCCC"/>
                                 <text id="必看说明" text="使用说明"  color="#FFFFFF"  gravity="center" textSize="20" marginTop="0" bg="?attr/selectableItemBackground" clickable="true"/>
                            </card>
                            <card w="*" h="50" cardCornerRadius="10dp" cardElevation="0dp" margin="20 15" >
                                 <View w="*" h="*" bg="#99CCCC"/>
                                 <text id="学习小手电" text="其他"  color="#FFFFFF"  gravity="center" textSize="20" marginTop="0" bg="?attr/selectableItemBackground" clickable="true"/>
                            </card>
    </vertical>
    );
...
ui.switchEnbleFloating.on("check", function (checked) {
    if (checked && !$floaty.checkPermission()) {
        toast("请在弹出的系统设置界面找到并开启“强国学习”的悬浮窗权限！");
...
//按钮点击事件
ui['必看说明']['click'](() => {
  app.openUrl("https://docs.qq.com/doc/DQmtPSlpSeFhWU2RF");
});
ui['学习小手电']['click'](() => {
  toast("😃")
